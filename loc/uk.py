...
HELP_CMD_DATA_RETENTION_INFO = \
    (
        ...
        f"**{config.DATA_RETENTION_PERIOD_DAYS} днів** ви здобудете статус \"не активний\" та втратите свій UID!\n\n"
...
GUILD_CONFIG_HELP_EMBED_TITLE = "Доступні значення для налаштування"
GUILD_CONFIG_HELP_INSTRUCTIONS = ("ℹ️ Це список доступних для налаштування значень у "
                                  "`/config value`.\n> Зразок: `/config value key:cooldown value:10800`")
GUILD_CONFIG_VALUE_ERROR = "❌ Вказане значення не відповідає потребам: `{}`"
GUILD_CONFIG_VALUE_SUCCESS = "✅ Ви успішно змінили значення `{0}` на `{1}`."

COOLDOWN_MESSAGE = "❌ Ви зможете використовувати цю команду {}"
